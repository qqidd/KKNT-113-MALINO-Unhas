...
<body>
    ...
    <div class="container">
        ...
        <!-- Form Edit Foto -->
        <form action="{{ route('kantor_foto.update', $foto->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <select name="kategori" id="kategori" required>
                <option value="GambarProfil" {{ $foto->kategori == 'GambarProfil' ? 'selected' : '' }}>GambarProfil
                </option>
                <option value="GambarHutan" {{ $foto->kategori == 'GambarHutan' ? 'selected' : '' }}>GambarHutan
                </option>
                <option value="GambarRiss" {{ $foto->kategori == 'GambarRiss' ? 'selected' : '' }}>GambarRiss
                </option>
                <option value="GambarTugu" {{ $foto->kategori == 'GambarTugu' ? 'selected' : '' }}>GambarTugu
                </option>
                <option value="GambarPasar" {{ $foto->kategori == 'GambarPasar' ? 'selected' : '' }}>GambarPasar
                </option>
            ...
            <!-- Tombol Kembali -->
            <a href="{{ route('layouts.adkan') }}" class="btn btn-back">
