                    ...
                    <div class="container mx-auto">
                        ...
                        <div class="mt-6 md:mt-10 m-4 md:m-10 text-white">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                /<span class="text-hijau font-bold">Pine Forest Database</span>
                            </div>
                            <div class="mt-6 md:mt-10 m-4 md:m-10 flex justify-center md:justify-end">
                                <form action="{{ route('kantor.adminhutan') }}" method="GET"
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-gray-hitamKTK">
                                        <td class="p-6 text-xl border border-putihA text-center text-white">
                                            {{ $loop->iteration }}</td>
                                        <td class="p-6 border border-putihA text-center text-white">{{ $hutan->nama }}
                                        </td>

                                        <!-- Deskripsi dipersingkat di mobile -->
                                        <td
                                            class="p-2 border pl-4 border-putihA text-white max-w-[300px] break-words overflow-hidden">
                                            <span class="md:hidden">{{ Str::limit($hutan->deskripsi, 50) }}</span>
                                            <span class="hidden md:block">{{ $hutan->deskripsi }}</span>
                                        </td>
                                        ...
                                        <td class="p-2 border border-putihA text-center">
                                            <img src="{{ Storage::url($hutan->foto) }}" alt="Foto {{ $hutan->nama }}"
                                        ...
                                        <td class="p-2 border border-putihA text-center">
                                            <div
                                                ...
                                                <a href="{{ route('kantor.hutan_foto.edit', $hutan->id) }}"
                                                ...
                                                <form action="{{ route('kantor.hutan_foto.destroy', $hutan->id) }}"
                                                    method="POST"
                        ...
                        <div
                            ...
                            <a href="{{ route('kantor.hutan_foto.create') }}"
