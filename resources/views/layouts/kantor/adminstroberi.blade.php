                    ...
                    <div class="container mx-auto">
                        ...
                        <div class="mt-6 md:mt-10 m-4 md:m-10 text-white">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                /<span class="text-hijau font-bold">Strawberry Database</span>
                            </div>
                            <div class="mt-6 md:mt-10 m-4 md:m-10 flex justify-center md:justify-end">
                                <form action="{{ route('kantor.adminstroberi') }}" method="GET"
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-gray-hitamKTK">
                                        ...
                                        <td
                                            ...
                                            <span class="md:hidden">{{ Str::limit($stroberi->deskripsi, 50) }}</span>
                                            <span class="hidden md:block">{{ $stroberi->deskripsi }}</span>
                                        </td>
                                        ...
                                        <td class="p-2 border border-putihA text-center">
                                            <img src="{{ Storage::url ($stroberi->foto) }}"
                                                alt="Foto {{ $stroberi->nama }}"
                                        ...
                                        <td class="p-2 border border-putihA text-center">
                                            <div
                                                ...
                                                <a href="{{ route('kantor.stroberi_foto.edit', $stroberi->id) }}"
                                                ...
                                                <form
                                                    action="{{ route('kantor.stroberi_foto.destroy', $stroberi->id) }}"
                                                    method="POST"
                        ...
                        <div
                            ...
                            <a href="{{ route('kantor.stroberi_foto.create') }}"
