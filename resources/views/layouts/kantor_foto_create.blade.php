...
<body>
    ...
    <div class="container">
        ...
        <form action="{{ route('kantor_foto.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <select name="kategori" id="kategori" required>
                ...
                <option value="GambarProfil">GambarProfil</option>
                <option value="GambarHutan">GambarHutan</option>
                <option value="GambarRiss">GambarRiss</option>
                <option value="GambarTugu">GambarTugu</option>
                <option value="GambarPasar">GambarPasar</option>
