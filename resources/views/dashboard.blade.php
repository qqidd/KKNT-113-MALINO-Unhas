                    ...
                    <div class="container mx-auto">
                        <div class="mt-10 m-10 text-white">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                /<span class="text-hijau font-bold">Tourism Database</span>
                            </div>
                        </div>
                            ...
                            <table class="w-full border border-putihA">
                                <thead>
                                    <tr class="bg-hitamKTK">
                                        ...
                                        <th class="p-2 border border-putihA text-white font-bold font-inter">LINK MAPS
                                        </th>
                                ...
                                <tbody>
                                    <tr class="bg-gray-hitamKTK">
                                        ...
                                        <td class="p-2 border pl-2 border-putihA text-white">{{ $gambar->nama }}</td>
                                        <td class="p-2 border pl-24 border-putihA text-white">{{ $gambar->deskripsi }}
                                        </td>
